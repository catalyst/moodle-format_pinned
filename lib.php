 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_pinned extends format_base {
    ...
    public function get_default_section_name($section) {
        if ($section->section == 0) {
            ...
            return get_string('section0name', 'format_pinned');
        } else {
    ...
    public function course_format_options($foreditform = false) {
        ...
        $icons = array (
            'report' => get_string('areachart', 'format_pinned'),
            'notifications' => get_string('bell', 'format_pinned'),
            'calc' => get_string('calculator', 'format_pinned'),
            'calendar' => get_string('calendar', 'format_pinned'),
            'duration' => get_string('clock', 'format_pinned'),
            'email' => get_string('envelope', 'format_pinned'),
            'siteevent' => get_string('globe', 'format_pinned'),
            'info' => get_string('info', 'format_pinned'),
            'new' => get_string('lightning', 'format_pinned'),
            'stats' => get_string('linechart', 'format_pinned'),
            'payment' => get_string('money', 'format_pinned'),
            'news' => get_string('newspaper', 'format_pinned'),
            'grades' => get_string('openbook', 'format_pinned'),
            'groupn' => get_string('person', 'format_pinned'),
            'group' => get_string('people', 'format_pinned'),
            'questions' => get_string('question', 'format_pinned'),
            'dashboard' => get_string('speedometer', 'format_pinned'),
            'star-rating' => get_string('star', 'format_pinned'),
            'checked' => get_string('tick', 'format_pinned'),
        );
        ...
        if ($courseformatoptions === false) {
            ...
            $courseformatoptions = array(
                ...
                'detailsheading' => array(
                    'default' => get_string('detailsheading', 'format_pinned'),
                    'type' => PARAM_TEXT,
                ),
                ...
                'resourcesheading' => array(
                    'default' => get_string('resourcesheading', 'format_pinned'),
                    'type' => PARAM_TEXT,
                ),
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            $courseformatoptionsedit = array(
                ...
                'completionstatus' => array(
                    'label' => get_string('completionstatus', 'format_pinned'),
                    'element_type' => 'advcheckbox',
                    'help' => 'completionstatus',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array( get_string('completionstatus_label', 'format_pinned'))
                ),
                'completiontracking' => array(
                    'label' => get_string('completiontracking', 'format_pinned'),
                    'element_type' => 'advcheckbox',
                    'help' => 'completiontracking',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array( get_string('completiontracking_label', 'format_pinned'))
                ),
                'detailsheading' => array(
                    'label' => get_string('detailsheading_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'detailsheading',
                    'help_component' => 'format_pinned',
                ),
                'sectionheading1' => array(
                    'label' => get_string('sectionheading1_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'sectionheading1',
                    'help_component' => 'format_pinned',
                ),
                'sectiontext1' => array(
                    'label' => get_string('sectiontext1_label', 'format_pinned'),
                    'element_type' => 'editor',
                    'help' => 'sectiontext1',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array(
                ...
                'sectionicon1' => array(
                    'label' => get_string('sectionicon1_label', 'format_pinned'),
                    'element_type' => 'select',
                    'help' => 'sectionicon1',
                    'help_component' => 'format_pinned',
                ...
                'sectionheading2' => array(
                    'label' => get_string('sectionheading2_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'sectionheading2',
                    'help_component' => 'format_pinned',
                ),
                'sectiontext2' => array(
                    'label' => get_string('sectiontext2_label', 'format_pinned'),
                    'element_type' => 'editor',
                    'help' => 'sectiontext2',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array(
                ...
                'sectionicon2' => array(
                    'label' => get_string('sectionicon2_label', 'format_pinned'),
                    'element_type' => 'select',
                    'help' => 'sectionicon2',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array($icons),
                ...
                'sectionheading3' => array(
                    'label' => get_string('sectionheading3_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'sectionheading3',
                    'help_component' => 'format_pinned',
                ),
                'sectiontext3' => array(
                    'label' => get_string('sectiontext3_label', 'format_pinned'),
                    'element_type' => 'editor',
                    'help' => 'sectiontext3',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array(
                ...
                'sectionicon3' => array(
                    'label' => get_string('sectionicon3_label', 'format_pinned'),
                    'element_type' => 'select',
                    'help' => 'sectionicon3',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array($icons),
                ...
                'sectionheading4' => array(
                    'label' => get_string('sectionheading4_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'sectionheading4',
                    'help_component' => 'format_pinned',
                ),
                'sectiontext4' => array(
                    'label' => get_string('sectiontext4_label', 'format_pinned'),
                    'element_type' => 'editor',
                    'help' => 'sectiontext4',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array(
                ...
                'sectionicon4' => array(
                    'label' => get_string('sectionicon4_label', 'format_pinned'),
                    'element_type' => 'select',
                    'help' => 'sectionicon4',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array($icons),
                ...
                'sectionheading5' => array(
                    'label' => get_string('sectionheading5_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'sectionheading5',
                    'help_component' => 'format_pinned',
                ),
                'sectiontext5' => array(
                    'label' => get_string('sectiontext5_label', 'format_pinned'),
                    'element_type' => 'editor',
                    'help' => 'sectiontext5',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array(
                ...
                'sectionicon5' => array(
                    'label' => get_string('sectionicon5_label', 'format_pinned'),
                    'element_type' => 'select',
                    'help' => 'sectionicon5',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array($icons),
                ...
                'resourcesheading' => array(
                    'label' => get_string('resourcesheading_label', 'format_pinned'),
                    'element_type' => 'text',
                    'help' => 'resourcesheading',
                    'help_component' => 'format_pinned',
                ),
                'reversedisplay' => array(
                    'label' => get_string('reversedisplay', 'format_pinned'),
                    'element_type' => 'advcheckbox',
                    'help' => 'reversedisplay',
                    'help_component' => 'format_pinned',
                    'element_attributes' => array( get_string('reversedisplay_label', 'format_pinned'))
                ),
            );
    ...
    public function inplace_editable_render_section_name($section, $linkifneeded = true,
        ...
        if (empty($edithint)) {
            $edithint = new lang_string('editsectionname', 'format_pinned');
        }
        if (empty($editlabel)) {
            $title = get_section_name($section->course, $section);
            $editlabel = new lang_string('newsectionname', 'format_pinned', $title);
        }
    ...
    public function section_action($section, $action, $sr) {
        ...
        $renderer = $PAGE->get_renderer('format_pinned');
    ...
    public function page_set_course(moodle_page $page) : void {
        ...
        if ($page->has_set_url()) {
            $url = new \format_pinned\course_url($page->url);
            ...
            if (!array_key_exists('section', $params) && preg_match('/course\/view\.php/', $path)) {
                ...
                $preferencename = 'format_pinned_resume_courseid_' . $courseid;
 ...
 * @return \core\output\inplace_editable
 */
function format_pinned_inplace_editable($itemtype, $itemid, $newvalue) {
    global $DB, $CFG;
 ...
 */
function format_pinned_before_footer() {
    global $PAGE;
    ...
    if ($contextlevel == CONTEXT_COURSE) {
        $targeturl = new \format_pinned\course_url($rawurl);
    } else if ($contextlevel == CONTEXT_MODULE) {
        $targeturl = new \format_pinned\course_url($url);
    }
