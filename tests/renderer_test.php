...
/**
 * Unit tesst for format_pinned renderer class.
 *
 ...
 * @group      format_pinned
 */
class format_pinned_renderer_testcase extends advanced_testcase {
    ...
    public function test_get_completion_counts() {
        ...
        $method = new ReflectionMethod('format_pinned_renderer', 'get_completion_counts');
